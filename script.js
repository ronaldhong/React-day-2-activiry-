...
class Factory {
  constructor(){
    ...
    this.customerBuild = function(car, options){
      return(`Building one ${car.color} ${car.trim} ${car.model} with the following options: ${options}`);
    }
  }
}
...
let mazda3 = new Car("mazada3", 4, "red", "hybrid", "automatic", "touring", "base", "premium", "leather", true)
...
let mazda3yellow = new Car("mazada3", 4, "yellow", "hybrid", "automatic", "touring", "base", "premium", "leather", true)
let options =["weather package", "satellite radio", "rear spoiler"]
console.log(mazda3.customerBuild(mazda3yellow, options));
...
// Write your code below:
let miataRfBlack = new Sport("Miata-RF", "Grand Touring", "manual", "hard top", "black", "leather", "premium", "premium")
let optionsmiataRf =["hid headlights", "sports suspension", "leather steering wheel", "heated seats", "adaptive cruise control"]
console.log(miataRfBlack.customerBuild(miataRfBlack, optionsmiataRf));
...
// Write your code below:
let trailBlazer = new Truck('trail blazer','blue',8,true,'standard',true,'sport')
...
// Write your code below:
let redtrailBlazer = new Truck('trail blazer','red',8,true,'standard',true,'sport')
let optionsTB = ["seat warmers", "tinted windows", "fog lamps"]
console.log(redtrailBlazer.customerBuild(redtrailBlazer, optionsTB));
